...
const ProductsRelated = ({ productId, categoryId }: ProductsRelatedProps) => {
    ...
    const { handleProductInCart, handleAddCart, handleDecreaseQuantityProduct, handleIncreaseQuantityProduct } = useCart();
    const { products, isLoading, isError } = useGetRelatedProducts(productId, categoryId);
